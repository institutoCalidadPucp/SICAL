...
MenuPermit.create(name: 'Custodias Trabajadas', tab_reference: 'historic_custodies', tab_icon: 'ti-clipboard', available_for_client: false, order: 7, role_id: 1, default: false, full_permit: true)
MenuPermit.create(name: 'Proformas', tab_reference: 'quotations', tab_icon: 'ti-money', available_for_client: false, order: 8, default: false, role_id: 1, full_permit: true)
MenuPermit.create(name: 'Cadena de Custodia', tab_reference: 'classified_services', tab_icon: 'ti-hummer', available_for_client: false, order: 9, default: false, role_id: 1, full_permit: true)
