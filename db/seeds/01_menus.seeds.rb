MenuPermit.create(name: 'Empleados', tab_reference: 'employees', tab_icon: 'ti-user', available_for_client: false, order: 1, default: true, full_permit: true)
MenuPermit.create(name: 'Cliente', tab_reference: 'clients', tab_icon: 'ti-user', available_for_client: false, order: 2, default: true, full_permit: true)
MenuPermit.create(name: 'Inventario', tab_reference: 'inventories', tab_icon: 'ti-package', available_for_client: false, order: 3, default: true, full_permit: true)
MenuPermit.create(name: 'Laboratorios', tab_reference: 'laboratories', tab_icon: 'ti-home', available_for_client: false, order: 4, default: true, full_permit: true)
...
MenuPermit.create(name: 'Ejecución de servicios', tab_reference: 'services', tab_icon: 'ti-hummer', available_for_client: false, order: 9, default: true, full_permit: true)
MenuPermit.create(name: 'Proformas', tab_reference: 'quotations', tab_icon: 'ti-money', available_for_client: true, order: 9, default: true, full_permit: true)
MenuPermit.create(name: 'Orden de Trabajo', tab_reference: 'work_orders', tab_icon: 'ti-hummer', available_for_client: false, order: 10, default: true, full_permit: true)
MenuPermit.create(name: 'Roles', tab_reference: 'roles', tab_icon: 'ti-id-badge', available_for_client: false, order: 11, default: true, full_permit: true)
MenuPermit.create(name: 'Logs', tab_reference: 'logs', tab_icon: 'ti-write', available_for_client: false, order: 12, default: true, full_permit: true)
