...
MenuPermit.create(name: 'Custodias', tab_reference: 'historic_custodies', tab_icon: 'ti-hummer', available_for_client: false, order: 11, default: true, full_permit: true)
