class RolesController < ApplicationController
  ...
  def create
    ...
    if @role.valid
      current_user.register_audit(message = nil, "added", @role.id, @role.name, @role.class.to_s)
  ...
  def update
    ...
    if @role.save
      current_user.register_audit(message = nil, "updated", @role.id, @role.name, @role.class.to_s)
      redirect_to roles_path
    else
      render :edit
    end 
