class ClassifiedServicesController < ApplicationController
  ...
  private
    ...
    def set_custody_table
      # Can be optimized by storing the dimensions in processed
      @rows = @sample_processed.amount        
      sample_id = @custody_order.sample_processed.sample_category_id
      method_id = @custody_order.sample_processed.sample_method_id
